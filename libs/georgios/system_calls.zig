        ...
        pub fn set_error(self: *Self, err: ErrorType) void {
            self.* = Self{.error_code = switch (ErrorType) {
                ...
                georgios.ExecError => switch (err) {
                    ...
                    georgios.ExecError.StreamTooLong => ErrorCode.StreamTooLong,
                    georgios.ExecError.EndOfStream => ErrorCode.EndOfStream,
                ...
                georgios.fs.Error => switch (err) {
                    ...
                    georgios.fs.Error.StreamTooLong => ErrorCode.StreamTooLong,
                    georgios.fs.Error.EndOfStream => ErrorCode.EndOfStream,
                ...
                georgios.io.FileError => switch (err) {
                    ...
                    georgios.io.FileError.StreamTooLong => ErrorCode.StreamTooLong,
                    georgios.io.FileError.EndOfStream => ErrorCode.EndOfStream,
                ...
                georgios.ThreadingOrFsError => switch (err) {
                    ...
                    georgios.ThreadingOrFsError.StreamTooLong => ErrorCode.StreamTooLong,
                    georgios.ThreadingOrFsError.EndOfStream => ErrorCode.EndOfStream,
            ...
            return switch (self.*) {
                ...
                Self.error_code => |error_code| switch (ErrorType) {
                    ...
                    georgios.ExecError => switch (error_code) {
                        ...
                        .StreamTooLong => georgios.ExecError.StreamTooLong,
                        .EndOfStream => georgios.ExecError.EndOfStream,
                    ...
                    georgios.fs.Error => switch (error_code) {
                        ...
                        .StreamTooLong => georgios.fs.Error.StreamTooLong,
                        .EndOfStream => georgios.fs.Error.EndOfStream,
                    ...
                    georgios.io.FileError => switch (error_code) {
                        ...
                        .StreamTooLong => georgios.io.FileError.StreamTooLong,
                        .EndOfStream => georgios.io.FileError.EndOfStream,
                    ...
                    georgios.ThreadingOrFsError => switch (error_code) {
                        ...
                        .StreamTooLong => georgios.ThreadingOrFsError.StreamTooLong,
                        .EndOfStream => georgios.ThreadingOrFsError.EndOfStream,
